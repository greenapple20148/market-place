...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 185.00,
    seller_name: 'TheLeatherWorkshop',
    seller_id: 'seller-4',
  ...
  },
  {
    ...
    price: 22.00,
    seller_name: 'BotanicalGlow',
    seller_id: 'seller-5',
    images: ['https://images.unsplash.com/photo-1602874801007-bd458bb1b8b6?auto=format&fit=crop&q=80&w=800'],
    category: Category.Home,
    rating: 4.6,
    reviews: 215,
  ...
  },
  {
    ...
    price: 48.00,
    seller_name: 'IndigoArts',
    seller_id: 'seller-7',
    images: ['https://images.unsplash.com/photo-1528460033278-a6ba57020470?auto=format&fit=crop&q=80&w=800'],
